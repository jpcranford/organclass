...
* How to Get Sound: Stops
  ...
  * Pitch lengths
    ...
    <img src="{{ site.baseurl }}/assets/images/pitch1.gif" style="float:right;width:25%;max-width:100px;filter:grayscale(100%) contrast(200%);">
    <img src="{{ site.baseurl }}/assets/images/pitch1.gif" style="float:right;width:25%;max-width:150px;filter:grayscale(100%) contrast(200%);">
    <img src="{{ site.baseurl }}/assets/images/pitch1.gif" style="float:right;width:25%;filter:grayscale(100%) contrast(200%);">

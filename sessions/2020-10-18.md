...
We'll go over this in more detail later, but to quickly find out which family a given pipe falls into, check out this [handy PDF]({{ site.baseurl }}/assets/pdfs/handout_common_stop_names.pdf) from BYU's *New Ward Organist* program.
